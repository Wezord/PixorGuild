...
public class GuiCloseButton extends GuiButton {
    ...
    protected static final ResourceLocation TEXTURE = new ResourceLocation(Constants.MODID, "textures/gui/close.png");

    public GuiCloseButton(int buttonId, int x, int y) {
        super(buttonId, x, y, "");
        width = 48 / 3;
        height = 48 / 3;
    }
